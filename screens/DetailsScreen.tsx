  ...
  return (
    <SafeAreaView className='h-full bg-white'>
      ...
      <View className='mt-10 p-6'>
        ...
        <View style={styles.toast} className='my-5 flex-row px-3 py-3 rounded-sm border-l-[6px] border-primary bg-white'>
            <MaterialIcons name='info' size={20} color='#40B37C' /> 
            <Text className='ml-2 w-[90%]'>
              Tap <Text className='font-bold'>Enter Chat Room</Text> on time to let the doctor know you&apos;re here.
            </Text>
        </View>
        <View className='mb-5 w-full p-4 bg-gray-100 rounded-xl'>
            <View className='flex-row pb-3 border-b-[1px] border-gray-300'>
                <MaterialIcons style={styles.calendar} name='calendar-today' size={25} />
                <View className='mt-1 ml-4'>
                    <Text style={{fontFamily:'poppins-bold'}}>Date & Time</Text>
                    <Text className='text-gray-500 font-medium'>Monday, 20 Jun 2022</Text>
                    <Text className='text-gray-500 font-medium'>08:00 AM</Text>
                </View>
            </View>
            <View className='flex-row border-gray-300 mt-3'>
                <MaterialIcons style={{...styles.calendar,backgroundColor:'#127357'}} color='#fff' name='chat' size={25} />
                <View className='mt-1 ml-4'>
      ...
      <View style={styles.toast} className='bg-white rounded-xl p-4 mt-4'>
        <View className='flex-row justify-between my-2'>
            <Text style={{fontFamily:'poppins-regular'}} className='text-base'>Total Price</Text>
            <Text style={{fontFamily:'poppins-regular'}} className='text-base'>$80.00</Text>
        </View>
        <View className='flex-row justify-between my-2'>
            <Text style={{fontFamily:'poppins-regular'}} className='text-base'>Tax</Text>
            <Text style={{fontFamily:'poppins-regular'}} className='text-base'>$8.00</Text>
        </View>
        <View className='flex-row justify-between my-2'>
            <Text style={{fontFamily:'poppins-bold'}} className='text-base'>Payment Total</Text>
            <Text style={{fontFamily:'poppins-bold'}} className='text-base'>$88.00</Text>
        </View>
      </View>
      </View>
    </SafeAreaView>
