  ...
  return (
    <View className='bg-green-800 rounded-xl flex-row p-4 my-4 justify-between'>
        <View>
            ...
            <View className='my-2'>
            <Text style={{fontFamily:'poppins-bold'}} className='text-base text-white'>Dr.Syed Rafay</Text>
        ...
        <View className='m-3 p-3 bg-green-600 rounded-lg'>
            ...
            <Text className='text-white font-medium mt-1 text-base'>Rajput Hospital</Text>
            <Text className='text-white font-medium mt-1 text-xs'>Today, 01:00 PM</Text>
        </View>
    </View>
  )
}
